        ...
        return GestureDetector(
          ...
          child: SafeArea(
            child: Scaffold(
              ...
              appBar: CustomAppBar2(title: 'Chats', isTitle: true,titleColor: AppPalette.whiteColor, actions: [
                IconButton(onPressed: () {}, icon: Icon(Icons.help_outline_rounded, color: AppPalette.whiteColor),),
              ...
              body: GestureDetector(
                ...
                child: ChatScreenBodyWidget(screenWidth: screenWidth, screenHeight: screenHeight),
              ),
